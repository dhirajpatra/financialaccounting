<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        @if (setting('general.admin_theme', 'skin-blue-light') == 'skin-blue-light')
            ...
            <span class="logo-mini"><img src="{{ asset('public/img/raha-logo-white.jpg') }}" class="logo-image-mini" width="25" alt="Akaunting Logo"></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img src="{{ asset('public/img/raha-logo-white.jpg') }}" class="logo-image-lg" width="25" alt="Akaunting Logo"> <b>Raha</b></span>
        @else
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><img src="{{ asset('public/img/raha-logo-green.jpg') }}" class="logo-image-mini" width="25" alt="Raha Logo"></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img src="{{ asset('public/img/raha-logo-green.jpg') }}" class="logo-image-lg" width="25" alt="Raha Logo"> <b>Raha</b></span>
        @endif
    </a>
    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <!-- Updates: style can be found in dropdown.less -->
                <li class="hidden-xs">
                    <a href="{{ url('https://euresiacoders.com/') }}" target="_blank" title="{{ trans('general.help') }}">
