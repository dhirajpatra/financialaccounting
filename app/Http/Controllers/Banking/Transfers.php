...
class Transfers extends Controller
{
    ...
    public function index()
    {
        ...
        return view('banking.transfers.index', compact('transfers', 'items', 'accounts', 'date_format'));
    }
    ...
    public function edit(Transfer $transfer)
    {
        ...
        return view('banking.transfers.edit', compact('transfer', 'accounts', 'payment_methods', 'date_format'));
    }
