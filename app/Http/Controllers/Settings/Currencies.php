...
use App\Traits\Currencies as CurrencyConverters;

class Currencies extends Controller
{
    use CurrencyConverters;
    ...
    public function edit(Currency $currency)
    {
        ...
        if ($currency->code != setting('general.default_currency')) {
            $currency->rate = $this->convertCurrencyRate(setting('general.default_currency'), $currency->code);
        }
