...
class Payments extends Controller
{
    ...
    public function index()
    {
        ...
        return view('expenses.payments.index', compact('payments', 'vendors', 'categories', 'accounts', 'transfer_cat_id', 'date_format'));
    }
    ...
    public function edit(Payment $payment)
    {
        ...
        return view('expenses.payments.edit', compact('payment', 'accounts', 'currencies', 'account_currency_code', 'vendors', 'categories', 'payment_methods', 'date_format'));
    }
