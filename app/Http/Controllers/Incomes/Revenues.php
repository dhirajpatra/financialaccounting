...
class Revenues extends Controller
{
    ...
    public function create()
    {
        ...
        return view('incomes.revenues.create', compact('accounts', 'currencies', 'account_currency_code', 'customers', 'categories', 'payment_methods', 'date_format'));
    }
    ...
    public function edit(Revenue $revenue)
    {
        ...
        return view('incomes.revenues.edit', compact('revenue', 'accounts', 'currencies', 'account_currency_code', 'customers', 'categories', 'payment_methods', 'date_format'));
    }
