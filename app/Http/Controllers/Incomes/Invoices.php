...
class Invoices extends Controller
{
    ...
    {
        $date_format = config('constants.date.date_format');
        ...
        return view('incomes.invoices.index', compact('invoices', 'customers', 'status', 'date_format'));
    }
    ...
    public function show(Invoice $invoice)
    {
        ...
        return view('incomes.invoices.show', compact('invoice', 'accounts', 'currencies', 'account_currency_code', 'customers', 'categories', 'payment_methods', 'date_format'));
    }
    ...
    public function edit(Invoice $invoice)
    {
        ...
        return view('incomes.invoices.edit', compact('invoice', 'customers', 'currencies', 'items', 'taxes', 'categories', 'date_format'));
    }
